...
<html>
  ...
  <head>
    <title> Explore | Shree Traders </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Items</a></li>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
      <img src="css/vegi.jpg" style="width:100%;">
